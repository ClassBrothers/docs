...
$meta['beschreibung'] = 'Ihre Newsletter-Anmeldung ist bestätigt.';
...
<section class="band">
  <div class="wrap schmal zentriert">
    <?php if ($zustand === 'ok'): ?>
      <h1>Passt, Sie sind eingetragen</h1>
      <p>
        Wir melden uns, wenn es etwas zu berichten gibt: wenn die Schwelle fällt, wenn
        die Produktion startet, wenn die Kartons unterwegs sind. Sonst hören Sie
        nichts von uns.
      </p>
    <?php else: ?>
      ...
      <p>
        ...
        Tragen Sie sich am besten noch einmal ein – dann schicken wir einen frischen Link.
      </p>
    <?php endif; ?>
    <p>
